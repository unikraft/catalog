...
This directory contains the build definition for the `unikraft.org/caddy:2.10` image.
...
```console
kraft run -M 512M -p 2015:2015 --plat qemu --arch x86_64 unikraft.org/caddy:2.10
```
