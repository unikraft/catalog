...
This directory contains the [Java](https://www.php.net/) runtime on Unikraft, in binary compatibility mode.
...
```bash
kraft run -M 1024M -p 8080:8080 --plat qemu --arch x86_64 unikraft.org/java:17
```
...
upbeat_jenny  project://java:qemu/x86_64  /usr/lib/jvm/java-17-openjdk-amd64/bin/java -classpath /usr/src/ SimpleHttpServer  16 seconds ago  running  0MiB  0.0.0.0:8080->8080/tcp  qemu/x86_64
```
...
```bash
kraft run -M 1024M -p 8080:8080 --plat qemu --arch x86_64 .
```
