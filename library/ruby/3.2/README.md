...
This directory contains the definition for the `unikraft.org/ruby:3.2` image starting a simple HTTP server.
...
kraft run -M 256M --network bridge:virbr0 --plat qemu --arch x86_64 unikraft.org/ruby:3.2
```
