...
```bash
kraft run --rm -p 6379:6379 --plat qemu --arch x86_64 -M 256M unikraft.org/mariadb:11.2
```
...
gracious_whiplash  project://dragonfly:qemu/x86_64  /usr/bin/dragonfly --maxmemory 2G  5 seconds ago  running  0MiB  0.0.0.0:6379->6379/tcp  qemu/x86_64
```

The instance name is `gracious_whiplash`.
