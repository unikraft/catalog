...
stoic_nyota  oci://unikraft.org/base:latest  /server  23 minutes ago  running  488M  0.0.0.0:8080->8080/tcp  qemu/x86_64
```

The instance name is `stoic_nyota`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm stoic_nyota
```
