# Node 24 Prisma Server - Distroless
...
suspicious_ferdinand  oci://unikraft.org/base:latest  /usr/bin/node /usr/src/server.js  6 minutes ago  running  1024M  0.0.0.0:3000->3000/tcp  qemu/x86_64
```

The instance name is `suspicious_ferdinand`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm suspicious_ferdinand
```
