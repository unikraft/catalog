...
This directory contains a Flask 3.0 HTTP server running on Unikraft using a minimal distroless-style root filesystem.

The Dockerfile builds the application dependencies in a Python 3.10 Bookworm environment and then copies only the Python runtime, required libraries, and application files into a minimal `scratch` image.
