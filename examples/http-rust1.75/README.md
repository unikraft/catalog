...
keen_ndakasi  oci://unikraft.org/base:latest  /server  8 minutes ago  running  64M  0.0.0.0:8080->8080/tcp  qemu/x86_64
```

The instance name is `keen_ndakasi`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm keen_ndakasi
```
